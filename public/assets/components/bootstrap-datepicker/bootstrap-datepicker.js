...
!function( $ ) {
	...
	var Datepicker = function(element, options){
		...
		this.format = DPGlobal.parseFormat(options.format||this.element.data('date-format')||'YYYY-MM-DD HH:mm:ss');
	...
	var DPGlobal = {
		...
		*/
		...
		formatDate: function(date, format){
			var stringDate = moment(date).format(format);
			return stringDate;
			/*
			var val = {
				d: date.getDate(),
